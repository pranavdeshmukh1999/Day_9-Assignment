...
public class AdressBook {
    ...
    public void AddressBook(String bookName, String firstName, String lastName, String address, String city, int zip,
    ...
    public void AddressBook(int id,String bookName, String firstName, String lastName, String address, String city, int zip,
                       String state, long phoneNumber, String email) {
        this.id = id;
        this.bookName = bookName;
        this.firstName = firstName;
